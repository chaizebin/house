$(function () {
    ...
    if (quyu != '' || block != '' || subway != '' || subway_station != '') {
        ...
        if (now_url.indexOf('page=') != -1 || now_url.indexOf('search_text') != -1) {
            $('.area dd .sub-list-box .sub_option_list>a').click(function () {
                ...
                if (nowtext != '不限') {
                    window.location.href = '/room/' + $('input[name="website-city-code"]').val() + '/b' + encodeURI(nowtext) + '.html';
                } else {
                    window.location.href = '/room/' + $('input[name="website-city-code"]').val() + '/d' + encodeURI(notext) + '.html';
                }
            });
            $('.subway dd .sub-list-box .sub_option_list>a').click(function () {
                var nowtext = $(this).text(),
                    notext = $(this).parents('.sub_option_list').siblings('a').text();
                if (nowtext != '不限') {
                    window.location.href = '/room/' + $('input[name="website-city-code"]').val() + '/s' + encodeURI(nowtext) + '.html';
                } else {
                    window.location.href = '/room/' + $('input[name="website-city-code"]').val() + '/l' + encodeURI(notext) + '.html';
                }
            })
            $('.subway dd .option_list>a,.area dd .option_list>a').click(function () {
                if ($(this).text() == '不限') {
                    ...
                    if (str.replace(encodeURI(select_text), '').length == 0) {
                        window.location.href = '/room/' + $('input[name="website-city-code"]').val();
                    }
                    else {
                        window.location.href = '/room/' + $('input[name="website-city-code"]').val() + '/' + str.replace(encodeURI(select_text + '-'), '') + '.html';
                    }
                }
            });
        } else {
                ...
                if (window.location.href.indexOf('.html') != -1) {
                    ...
                    $('.area dd .sub-list-box .sub_option_list>a').click(function () {
                        var nowtext = $(this).text(),
                            notext = $(this).parents('.sub_option_list').siblings('a').text();
                        if (nowtext != '不限') {
                            window.location.href = '/room/' + $('input[name="website-city-code"]').val() + '/b' + encodeURI(nowtext + str) + '.html';
                        } else {
                            window.location.href = '/room/' + $('input[name="website-city-code"]').val() + '/d' + encodeURI(notext + str) + '.html';
                        }
                    });
                    $('.subway dd .sub-list-box .sub_option_list>a').click(function () {
                        var nowtext = $(this).text(),
                            notext = $(this).parents('.sub_option_list').siblings('a').text();
                        if (nowtext != '不限') {
                            window.location.href = '/room/' + $('input[name="website-city-code"]').val() + '/s' + encodeURI(nowtext + str) + '.html';
                        } else {
                            window.location.href = '/room/' + $('input[name="website-city-code"]').val() + '/l' + encodeURI(notext + str) + '.html';
                        }
                    })
                } else {
                    $('.area dd .sub-list-box .sub_option_list>a').click(function () {
                ...
                if (window.location.href.indexOf('.html') != -1) {
                    $('.area dd .sub-list-box .sub_option_list>a').click(function () {
                        var nowtext = $(this).text(),
                            notext = $(this).parents('.sub_option_list').siblings('a').text();
                        if (nowtext != '不限') {
                            window.location.href = '/room/' + $('input[name="website-city-code"]').val() + '/b' + encodeURI(nowtext) + '-' + str;
                        } else {
                            window.location.href = '/room/' + $('input[name="website-city-code"]').val() + '/d' + encodeURI(notext) + '-' + str;
                        }
                    });
                    $('.subway dd .sub-list-box .sub_option_list>a').click(function () {
                        var nowtext = $(this).text(),
                            notext = $(this).parents('.sub_option_list').siblings('a').text();
                        if (nowtext != '不限') {
                            window.location.href = '/room/' + $('input[name="website-city-code"]').val() + '/s' + encodeURI(nowtext) + '-' + str;
                        } else {
                            window.location.href = '/room/' + $('input[name="website-city-code"]').val() + '/l' + encodeURI(notext) + '-' + str;
                        }
                    })
                } else {
                    $('.area dd .sub-list-box .sub_option_list>a').click(function () {
    ...
    $.get('/room/guesslist/' + encodeURI(input_val), function (data) {
        if (data.length > 0) {
