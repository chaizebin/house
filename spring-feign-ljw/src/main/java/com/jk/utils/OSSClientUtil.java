...
public class OSSClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAILZmQYNJQ9Acb";
    private String accessKeySecret = "il2dH1izwEcXATTKXZ5ZY19DDK0kUU";
    // 空间
    private String bucketName = "lijingwei";
    // 文件存储目录
    private String filedir = "lidudu/";
