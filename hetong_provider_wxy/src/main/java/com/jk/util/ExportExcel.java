...
public class ExportExcel {
     ...
     */
    public static void exportExcel(String sheetName, String titleName, String[] headers, Collection<?> dataSet, OutputStream output, String pattern) {

        doExportExcel(sheetName,titleName,headers,dataSet,output,pattern);
     ...
     * 功能:真正实现导出
     */
    private static void doExportExcel(String sheetName,String titleName,String[] headers,Collection<?> dataSet,OutputStream output,String pattern) {
